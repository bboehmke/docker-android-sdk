...
RUN curl -sSL https://services.gradle.org/distributions/gradle-2.10-bin.zip -o /tmp/gradle-bin.zip && \
...
# set path
ENV PATH $PATH:${ANDROID_HOME}/tools:$ANDROID_HOME/platform-tools:/usr/local/gradle-2.10/bin
